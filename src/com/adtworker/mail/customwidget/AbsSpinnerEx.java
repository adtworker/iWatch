...
public abstract class AbsSpinnerEx extends AdapterViewEx<SpinnerAdapter> {
	...
	public AbsSpinnerEx(Context context) {
		super(context);
		initAbsSpinner();
	}

	public AbsSpinnerEx(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public AbsSpinnerEx(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		initAbsSpinner();
		/*
		 * TypedArray a = context.obtainStyledAttributes(attrs,
		 * com.android.internal.R.styleable.AbsSpinnerEx, defStyle, 0);
		 * 
	...
	void recycleAllViews() {
		...
		final AbsSpinnerEx.RecycleBin recycleBin = mRecycler;
	...
	static class SavedState extends BaseSavedState {
		...
		/**
		 * Constructor called from {@link AbsSpinnerEx#onSaveInstanceState()}
		 */
