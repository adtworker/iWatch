...
public abstract class AdapterViewEx<T extends Adapter> extends ViewGroup {
	/**
	 * The item view type returned by ##when the adapter does not want the
	 * item's view recycled.
	 */
	public static final int ITEM_VIEW_TYPE_IGNORE = -1;

	/**
	 * The item view type returned by ## when the item is a header or footer.
	 */
	...
	public AdapterViewEx(Context context, AttributeSet attrs, int defStyle) {
	...
	public interface OnItemClickListener {
		 ...
		 */
		void onItemClick(AdapterViewEx<?> parent, View view, int position,
				long id);
	}
	...
	public interface OnItemLongClickListener {
		 ...
		 */
		boolean onItemLongClick(AdapterViewEx<?> parent, View view,
	...
	public interface OnItemSelectedListener {
		 ...
		 */
		void onItemSelected(AdapterViewEx<?> parent, View view, int position,
				long id);
		 ...
		 */
		void onNothingSelected(AdapterViewEx<?> parent);
	}
	...
	class AdapterDataSetObserver extends DataSetObserver {
		...
		public void onChanged() {
			...
			if (AdapterViewEx.this.getAdapter().hasStableIds()
					&& mInstanceState != null && mOldItemCount == 0
					&& mItemCount > 0) {
				AdapterViewEx.this.onRestoreInstanceState(mInstanceState);
				mInstanceState = null;
			} else {
				rememberSyncState();
			}
		...
		public void onInvalidated() {
			...
			if (AdapterViewEx.this.getAdapter().hasStableIds()) {
				...
				mInstanceState = AdapterViewEx.this.onSaveInstanceState();
			}
